...
def main():
    formula = input("Enter the formula for a molecule: ")
    mass = float(input("Enter the mass in grams of a sample of the substance: "))

    molar_mass = compute_molar_mass(formula)
    number_of_moles = mass / molar_mass

    print(f"The molar mass of {formula} is {molar_mass:.4f} grams/mol.")
